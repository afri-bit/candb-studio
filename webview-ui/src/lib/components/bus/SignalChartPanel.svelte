...
<style>
  ...
  .signal-picker {
    ...
    min-height: 0;
    border: 1px solid
      var(--vscode-widget-border, color-mix(in srgb, var(--vscode-foreground) 14%, transparent));
    border-radius: 8px;
  ...
  .picker-header {
    ...
    border-bottom: 1px solid
      var(--vscode-widget-border, color-mix(in srgb, var(--vscode-foreground) 12%, transparent));
  }
