        ...
        <div class="detail-panel dbc-card node-detail-card">
          ...
          <div class="dbc-card-body node-tab-body">
            ...
            {:else if nodeTab === 'mappedTx'}
              <div class="mapped-toolbar">
                <button
                  ...
                  disabled
                  title="Edit mappings in Messages → Signals">Add: individual signal</button
                >
                <button
                  type="button"
                  class="btn btn-disabled"
                  disabled
                  title="Link signals via Messages tab">Add: all from one message</button
                >
                <button
                  type="button"
                  class="btn btn-disabled"
            ...
            {:else if nodeTab === 'mappedRx'}
              <div class="mapped-toolbar">
                <button
                  ...
                  class="btn btn-disabled"
                  disabled
                  title="Add receiver on the signal definition">Add: individual signal</button
                >
                <button
                  type="button"
                  class="btn btn-disabled"
                  disabled
                  title="Bulk-edit receivers via signal pool">Add: all from one message</button
                >
                <button
                  type="button"
                  class="btn btn-disabled"
            ...
            {:else if nodeTab === 'attributes'}
              <p class="empty-tab">
                Node-level attribute instances are not edited in the visual database view yet. Use
                the text editor for <code>BA_</code> /
