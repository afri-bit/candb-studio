...
export type WebviewToExtensionMessage =
    ...
    | {
          type: 'updateNode';
          payload: { documentUri: string; nodeName: string; changes: Record<string, unknown> };
      }
    ...
    | {
          type: 'startPeriodicTransmit';
          payload: { taskId: string; id: number; data: number[]; dlc: number; intervalMs: number };
      }
