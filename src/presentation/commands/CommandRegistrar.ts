...
export class CommandRegistrar {
    ...
    registerAll(): vscode.Disposable[] {
        return [
            vscode.commands.registerCommand(Commands.OPEN_DATABASE, () =>
                this.openDatabaseCommand.execute(),
            ),
            vscode.commands.registerCommand(Commands.CONNECT_BUS, () =>
                this.connectCommand.execute(),
            ),
            vscode.commands.registerCommand(Commands.DISCONNECT_BUS, () =>
                this.disconnectCommand.execute(),
            ),
            vscode.commands.registerCommand(Commands.START_MONITOR, () =>
                this.monitorService?.start(),
            ),
            vscode.commands.registerCommand(Commands.STOP_MONITOR, () =>
